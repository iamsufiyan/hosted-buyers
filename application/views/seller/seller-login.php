...
<html lang="en">
    ...
    <body background="http://backgroundcheckall.com/wp-content/uploads/2017/12/login-page-background-images-hd-10.jpg">
        <?php
        ...
        <div class="limiter">
            <div class="container-login100" style="">
                <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54" style="backhround:#f3f3f3">
                    ...
                    echo "</div>";
                    ?>
                    <form class="login100-form validate-form" action="<?php echo base_url() ?>seller-dashboard" method="post" accept-charset="utf-8">
