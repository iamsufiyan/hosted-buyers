        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        <a style="color:black" href="<?php echo base_url() ?>seller-add-profile" class="nav-link">Profile</a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a href="<?php echo base_url() ?>seller-log-out"><div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <a href="#" class="d-block"><a href="<?php echo base_url(); ?>seller-add-profile"><?php echo "$username" ?></a>
                        </div>
                    </div>
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <a href="<?php echo base_url(); ?>seller-dashboard"><li class="nav-item">
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item has-treeview">
                                        <a href="<?php echo base_url() ?>seller-add-profile" class="nav-link">
