...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-info">
            ...
            $result = $this->buyer_model->select_buyers_ref($refno_gen);
            ...
            <br>
            <br>
            <form role="form" action="<?php echo base_url() ?>upload-image"  id="myform" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                <div class="row" style="margin-right: 0px; margin-left: 0px;">
                    ...
                    <div class="col-md-3" style="margin-top:29px">
                        <input type="submit" name="submit" value="Upload" id="submit"  class="btn btn-info" />
                    </div>
                </div>
            </form>
            <br>
            ...
            <br>
            <form class="form-horizontal" action="<?php echo base_url() ?>insert-profile" method="post" accept-charset="utf-8">                    
                <input type="hidden" name="refno" class="form-control" value="<?php echo $row->refno_gen ?>" placeholder="Enter Register Number">
                <div class="row" style="margin-right: 0px; margin-left: 0px;">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="regno" class="col-sm-6 control-label">Regno</label>
                            <div class=" ">
                                <input type="text" name="regno" class="form-control" value="<?php echo $row->regno ?>" placeholder="Enter Register Number">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
