...
<html lang="en">
    ...
    if (isset($this->session->userdata['logged_in'])) {
        ...
        header("location: http://iitmindia.com/hosted-buyers/index.php/Admin_registration/admin_login");
    }
    ?>
    <head>
        ...
        <div class="limiter">
            <div class="container-login100" style="background-image: url('<?php echo base_url() . "asset/"; ?>images/bg-01.jpg');">
                <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                    ...
                    echo "</div>";
                    ?>
                    <form class="login100-form validate-form" action="<?php echo base_url() ?>index.php/Admin_registration/dashboard" method="post" accept-charset="utf-8">
                        <span class="login100-form-title p-b-49">
                            <img src="http://iitmindia.com/hosted-buyers/images/HB.jpg" class="img-fluid">
                        </span>
